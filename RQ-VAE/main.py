...
from datasets_ori import EmbDataset as EmbDataset_ori
...
def parse_args():
    ...
    parser.add_argument("--dataset", type=str, default="Instruments", help="Input dataset.")
...
if __name__ == '__main__':
    ...
    """build dataset"""
    data = EmbDataset_ori(args.data_path)
    ...
    trainer = Trainer(args, model, train_dataset=data)
